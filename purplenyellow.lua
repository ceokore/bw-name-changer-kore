...
local GradientSpeed = 45 -- degrees per second
...
Gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(60,0,90)),   -- dark purple
    ColorSequenceKeypoint.new(1, Color3.fromRGB(170,140,0))  -- dark yellow
}
Gradient.Rotation = 0
Gradient.Parent = NameBox

-- get blended color from gradient
local function GetGradientColor()
    local t = (math.sin(math.rad(Gradient.Rotation)) + 1) / 2
    return Color3.fromRGB(60,0,90):Lerp(Color3.fromRGB(170,140,0), t)
end
...
local function StartSystem()
    ...
    Connection = RunService.Heartbeat:Connect(function(dt)
        ...
        -- rotate gradient
        Gradient.Rotation += GradientSpeed * dt

        local NewColor = GetGradientColor()
